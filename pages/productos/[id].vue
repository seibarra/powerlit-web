            ...
            <div class="max-w-[450px]">
                ...
                <div class="flex flex-col items-end mt-5">
                    <div>
                        ...
                        <button class="mt-4 text-xl text-center float-end text-white bg-blue-500 rounded-md hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium w-full sm:w-auto px-5 py-2.5">
                            Comprar
                        </button>
                    </div>
                </div>
