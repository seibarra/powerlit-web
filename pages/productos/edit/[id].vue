        ...
        <div class="flex max-md:flex-col gap-5 justify-center">
            <div class="h-full md:sticky md:top-0">
                ...
                <div v-if="product.imagesURLs.length > 1" class="flex gap-5 w-full my-16">
                    ...
                    class="border-2 border-slate-500 rounded-lg p-2 max-w-[120px] max-md:max-w-[60px] cursor-pointer hover:bg-slate-100 relative"
            ...
            <div class="max-w-[450px]">
                ...
                <div class="flex justify-between items-center mt-5 max-sm:flex-col gap-5">
